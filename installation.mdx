...
<Tabs>
  ...
  <Tab title="From PyPI (Coming Soon)">
    ...
    <Warning>
      This method is not yet available. Use development or production installation for now.
    </Warning>
  </Tab>
</Tabs>
...
<Note>
  Service installation currently supports macOS via launchd. Linux systemd support is coming soon.
</Note>
